...
namespace HereAPI.Routing.TypesEnum
{
    ...
    {
        /// <summary>
        /// Contains copyright notices that must be displayed to the end user when using data
        /// provided by Transit Agencies.
        /// </summary>
        [Description("copyright")] Copyright,

        /// <summary>
        /// Indicates that routing options have been violated, in other words, the route contains
        /// route features that should have been avoided. The service provides the violated routing
        /// feature as text.
        /// </summary>
        ...
        /// <summary>
        /// Indicates time dependent restrictions for the segment following the maneuver, such as
        /// "road closed in winter". The service provides the validity period of this restriction in
        /// the corresponding note.
        /// </summary>
        [Description("timeDependentRestriction")] TimeDependentRestriction,

        /// <summary>
        /// Indicates the name of a previous intersection in a maneuver, such as for indicating the
        /// last intersection before arrival. The service provides the name of the intersection along
        /// with a descriptive text in the Text field of the corresponding note, such as "The last
        /// intersection is Markkulantie"
        /// </summary>
        [Description("previousIntersection")] PreviousIntersection,

        /// <summary>
        /// Indicates the name of a next intersection in a maneuver, such as for indicating the first
        /// intersection after arrival. The service provides the name of the intersection along with
        /// a descriptive text in the Text field of the corresponding note, such as "If you reach
        /// Rantalantie, you've gone too far".
        /// </summary>
        [Description("nextIntersection")] NextIntersection,

        /// <summary>
        /// Indicates that some part of route crosses administrative division border (state,
        /// province, etc.)
        /// </summary>
