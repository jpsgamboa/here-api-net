...
namespace HereAPI.Routing.Services
{
    ...
    {
        /// <summary>
        /// Since Routing Requests have common types, makes sense to have a base class to handle the json conversions
        /// and avoid repetition on each request (calculateRoute, getRoute, etc)
        /// </summary>
