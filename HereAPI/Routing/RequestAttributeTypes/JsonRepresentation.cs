...
namespace HereAPI.Routing.RequestAttributeTypes
{
    public class JsonRepresentation : IRequestAttribute
    {
        ...
        /// <summary>
        /// Only use this parameter if you only intend to get the compiled URL and not make the request using this library.
        /// As this changes the JSON response, it's likely that the library will fail to deserialize it.
        /// </summary>
        ...
        public enum JsonAttribute
        {
            ...
            /// <summary>
            /// Include _type element in JSON output for classes with abstract parent classes, this is default behaviour.
            /// </summary>
            ...
            /// <summary>
            /// Flatten list of shape strings to double arrays containing lat/lon pairs. 
            /// Potentially available altitude values are not returned. 
            /// By default shapes are returned as lists of strings.
            /// </summary>
            FlattenListOfShapesToDoubleArraysLatLon = 32,
            /// <summary>
            /// Flatten list of shape strings to double arrays containing lat/lon/alt triplets. 
            /// Altitude values are returned if available. 
            /// By default shapes are returned as lists of strings.
            /// </summary>
