...
{
    /// <summary>
    /// To provide an estimate of time that is as close to the current reality as possible, the
    /// DynamicSpeedInfoType contains dynamic speed information on the link.
    /// <para/>
    /// The service provides this data if the departure time and date is part of the route
    /// calculation request. If traffic is enabled for the request, the route calculation accounts for:
    /// <para/>
    ...
    public class DynamicSpeedInfo
    {
        ...
        /// <summary>
        /// The number between 0.0 and 10.0 indicating the expected quality of travel, where 0 is
        /// high quality and 10.0 is poor quality or high level of traffic jam. -1.0 indicates that
        /// the service could not calculate Jam Factor.
        /// </summary>
