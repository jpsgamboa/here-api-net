...
{
    /// <summary>
    /// Source attribution contains information that must be displayed in the user interface of
    /// applications using Routing API. Source attributions are produced, for example, when route is
    /// using information available through certain public transportation data providers. Attribution
    /// contains localized ready-to-display string with HTML markup as well as structured information
    /// that could be used to get data without parsing attribution string. Source attribution
    /// contains as well additional information in form of SourceSupplierNote - extra information
    /// which varies from supplier to supplier.
    /// </summary>
    public class SourceAttribution
    {
        ...
        public class SourceSupplier
        {
            ...
            public class SourceSupplierNote
            {
                ...
                /// <summary>
                /// Ready-to-display note text. The text may contain HTML text and markup, including
                /// hyperlinks (i.e. &lt;a href&gt; elements).
                /// </summary>
