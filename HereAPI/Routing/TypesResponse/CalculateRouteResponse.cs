...
namespace HereAPI.Routing.Services.TypeResponse
{
    ...
    public class CalculateRouteResponse
    {
        ...
        /// <summary>
        /// Contains copyright information intended for the end user when route uses data provided by
        /// outside companies. Source attribution must be displayed together with a route according
        /// to terms and conditions of the API. <see href="https://developer.here.com/documentation/routing/topics/resource-type-source-attribution.html"/>
        /// </summary>
