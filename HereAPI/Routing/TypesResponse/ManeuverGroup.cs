...
{
    /// <summary>
    /// Maneuver groups organize maneuvers into sections based on TransportModeType to better provide
    /// the user with an itinerary summary and brief route instructions.
    /// </summary>
