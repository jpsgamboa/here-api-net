...
namespace HereAPI.Routing.TypesResponse
{
    ...
    /// RouteLegType contains information about a route leg, such as the time required to traverse it, 
    /// its shape, start and end point, as well as information about any sublegs contained in the leg
    /// due to the presence of passthrough waypoints.
    /// <see href="https://developer.here.com/documentation/routing/topics/resource-type-route-leg.html"/>
    /// </summary>
    public class Leg
    {
        /// <summary>
        ...
        /// Considers any available traffic information, if enabled and authorized for the user. 
        /// </summary>
